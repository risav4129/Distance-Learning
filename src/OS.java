...
public class OS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(352, 46, 140, 26);

        jli1.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jli1.setPreferredSize(new java.awt.Dimension(73, 168));
        jScrollPane1.setViewportView(jli1);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(210, 150, 130, 180);
        ...
        jButton1.setBounds(400, 270, 150, 47);

        jLabel3.setText("* Please Select The Unit And Click Open");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(10, 450, 230, 16);

        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\Risav Chaudhary\\Pictures\\download (8).jpg")); // NOI18N
 ...
 int a = jli1.getSelectedIndex();
        if (a==0)
        {
            try
            {
                Runtime.getRuntime().exec("rundll32 url.dll, FileProtocolHandler "+"F:\\Semester 3\\Operating System\\Unit1.pptx");
            }
            catch (Exception e)
                    {
